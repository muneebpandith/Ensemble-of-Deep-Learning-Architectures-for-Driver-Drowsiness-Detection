...
def main():
  ...
  os.system("tar -czvf '../../MTECHMINORLINUX/DATA/annotatednewsubjectwise.tar.gz' '../../MTECHMINORLINUX/DATA/annotatednewsubjectwise' >> tarofannotatednewsubjectwisefiles.txt")
  return 1
